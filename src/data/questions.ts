...
export const EMOTIONS: WeatherEmotion[] = [
  ...
  },
  {
    ...
    emoji: '🌫️',
    label: '답답한',
    description: '안개 속에 갇힌 듯 숨통이 막히고 뻐근한 기분',
    theme: 'blue',
  },
  {
    id: 'anxious',
  ...
  },
  {
    ...
    emoji: '⏳',
    label: '초조한',
    description: '시간에 쫓기듯 가슴이 두근거리고 조급한 마음',
    theme: 'amber',
  },
  {
    id: 'annoyed',
    emoji: '🔥',
    label: '짜증·분노',
    description: '열기가 차오르듯 불쑥 화나고 억울한 상태',
    theme: 'rose',
  },
  {
    id: 'sensitive',
  ...
  },
  {
    ...
    emoji: '🪫',
    label: '무기력한',
    description: '아무것도 하기 싫고 마음 배터리가 바닥난 상태',
    theme: 'amber',
  },
  {
    id: 'lonely',
    emoji: '🍂',
    label: '외로운',
    description: '가을바람처럼 혼자 남겨진 듯 쓸쓸하고 허전함',
    theme: 'blue',
  },
  {
    id: 'overwhelmed',
    emoji: '🧗',
    label: '부담스러운',
    description: '무거운 짐을 진 듯 책임감에 짓눌리는 느낌',
    theme: 'purple',
  },
  {
    id: 'confused',
    emoji: '🌀',
    label: '혼란스러운',
    description: '갈피를 잡기 어렵고 머릿속이 복잡한 상태',
    theme: 'purple',
  },
  {
    id: 'peaceful',
  ...
  },
  {
    ...
    emoji: '🌿',
    label: '감사한',
    description: '은은한 풀내음처럼 주변에 고마움이 스미는 상태',
    theme: 'emerald',
  },
  {
    id: 'confident',
    emoji: '🌈',
    label: '자신감 있는',
    description: '비 갠 뒤 무지개처럼 해낼 수 있다는 용기',
    theme: 'cyan',
  },
  {
    id: 'relieved',
    emoji: '☕',
    label: '안도하는',
    description: '긴 폭풍이 지나가고 따뜻한 차 한 잔 같은 안식',
    theme: 'emerald',
  },
];
